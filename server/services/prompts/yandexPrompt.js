...
export const YANDEX_RESPONSE_JSON_SCHEMA = Object.freeze({
  ...
  properties: {
    ...
    formattedText: {
      type: "string",
      description: "Полный текст документа. Каждая строка начинается с H| для заголовка, P| для абзаца или поля, L| для пункта списка."
    },
...
- Каждую самостоятельную часть возвращай с новой строки и обязательным префиксом: H| для явного заголовка, P| для абзаца, реквизита или поля, L| для каждого пункта настоящего списка.
